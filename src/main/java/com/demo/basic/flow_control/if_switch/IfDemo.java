 ...
 * 无论是if或者if-else或者if-else if-else, 每次只能执行一个分支
...
public class IfDemo {
    ...
    public void testIf() {
        ...
        // 验证码
        String verifiedCode = "0000";

        if (username != "admin" || password != "123456" || verifiedCode != "0000") {
    ...
    @Test
    public void testIf3() {
        List<String> all = Arrays.asList("B.java", "B.java", "A.class", "B.class", "a.c");
        List<String> javaSourceFile = new ArrayList<>();
        List<String> javaClassFile = new ArrayList<>();
        List<String> cSourceFile = new ArrayList<>();
        for (String item : all) {
     ...
     * }
     * <p>
     * 单行代码块可以省略{}，但是不建议这么做，即使条件执行体只有一行代码, 因为{}使得代码具有更好的可读性
     */
    @Test
    public void testIf4() {
        int age = 33;
    ...
    public void testIf5() {
        ...
        //System.out.println(role); //Variable 'role' might not have been initialized
    }
    ...
    public void test2_3() {
        ...
        System.out.println("我总是会被执行");//这条语句不属于else语句
    }

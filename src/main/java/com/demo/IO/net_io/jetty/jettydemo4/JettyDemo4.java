package com.demo.IO.net_io.jetty.jettydemo4;
...
public class JettyDemo4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        servletHolder.setInitParameter("resteasy.resources", "com.demo.IO.socket.jetty.jettydemo4.RestEasyController");//关联controller，这里可以关联多个controller
        ...
        // 这里设置成 /* 或者 /rest/* 或者 /rest/v1/*, prefix中 /rest/v1/ 都会符合该url-pattern，那么请求就会分配到prefix对应的url
